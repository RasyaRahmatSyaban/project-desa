...
const DanaKeluarForm = ({ onSubmit, onCancel, initialData, isEditing }) => {
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className="bg-red-100 p-2 rounded-lg">
              <FaMoneyCheckAlt className="text-red-500" size={20} />
            </div>
            <h2 className="font-semibold text-xl text-gray-800">
              {isEditing ? "Edit Data Pengeluaran" : "Tambah Data Pengeluaran"}
            </h2>
          </div>
          <button
            onClick={onCancel}
