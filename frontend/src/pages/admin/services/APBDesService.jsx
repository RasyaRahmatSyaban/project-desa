...
const APBDesService = {
  ...
  getAllDanaMasuk: async () => {
    try {
      console.log("Fetching dana masuk from:", `${API_URL}/dana/apbdes/dana-masuk`)
      const response = await api.get("/dana/apbdes/dana-masuk")
      console.log("Dana masuk response:", response.data)
  ...
  updateDanaMasuk: async (id, danaMasukData) => {
    try {
      const response = await api.put(`/dana/apbdes/dana-masuk/${id}`, danaMasukData)
      return response.data
    } catch (error) {
  ...
  getAllDanaKeluar: async () => {
    try {
      console.log("Fetching dana keluar from:", `${API_URL}/dana/apbdes/dana-keluar`)
      const response = await api.get("/dana/apbdes/dana-keluar")
      console.log("Dana keluar response:", response.data)
      return response.data.data || []
    } catch (error) {
  ...
  addDanaKeluar: async (danaKeluarData) => {
    try {
      const response = await api.post("/dana/apbdes/dana-keluar", danaKeluarData)
      return response.data
    } catch (error) {
  ...
  updateDanaKeluar: async (id, danaKeluarData) => {
    try {
      const response = await api.put(`/dana/apbdes/dana-keluar/${id}`, danaKeluarData)
      return response.data
    } catch (error) {
