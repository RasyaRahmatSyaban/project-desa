...
const PendudukService = {
  ...
  getAllPenduduk: async () => {
    try {
      console.log("Fetching penduduk from:", `${API_URL}/penduduk`)
      const response = await api.get("/penduduk")
      console.log("Penduduk response:", response.data)
  ...
  getTotalPenduduk: async () => {
    try {
      console.log("Fetching total penduduk from:", `${API_URL}/penduduk/stats/total`)
      const response = await api.get("/penduduk/stats/total")
      console.log("Total penduduk response:", response.data)
      return response.data.data
    } catch (error) {
