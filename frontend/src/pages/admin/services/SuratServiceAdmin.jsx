...
const SuratService = {
  ...
  getAllSurat: async () => {
    try {
      console.log("Fetching all surat from:", `${API_URL}/surat`)
  ...
  getSuratMasuk: async () => {
    try {
      console.log("Fetching surat masuk from:", `${API_URL}/surat/suratMasuk`)
  ...
  getSuratKeluar: async () => {
    try {
      console.log("Fetching surat keluar from:", `${API_URL}/surat/suratKeluar`)
  ...
  addSuratMasuk: async (formData) => {
    try {
      ...
      if (formData.has("file")) {
        ...
        console.log("Renamed 'file' field to 'file_surat' to match server expectation")
      }

      // Use axios directly with the token in headers
      const response = await axios.post(`${API_URL}/surat/addSuratMasuk`, formData, {
        headers: {
  ...
  addSuratKeluar: async (formData) => {
    try {
      ...
      // Use axios directly with the token in headers
      const response = await axios.post(`${API_URL}/surat/addSuratKeluar`, formData, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${token}`,
          "ngrok-skip-browser-warning": "true",
  ...
  updateSuratMasuk: async (id, formData) => {
    try {
      ...
      const response = await axios.put(`${API_URL}/surat/update-surat-masuk/${id}`, formData, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${token}`,
          "ngrok-skip-browser-warning": "true",
  ...
  updateSuratKeluar: async (id, formData) => {
    try {
      ...
      const response = await axios.put(`${API_URL}/surat/update-surat-keluar/${id}`, formData, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${token}`,
          "ngrok-skip-browser-warning": "true",
  ...
  deleteSuratMasuk: async (id) => {
    try {
      ...
      const response = await axios.delete(`${API_URL}/surat/delete-surat-masuk/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
          "ngrok-skip-browser-warning": "true",
        },
  ...
  deleteSuratKeluar: async (id) => {
    try {
      ...
      // Delete the surat record
      const response = await axios.delete(`${API_URL}/surat/delete-surat-keluar/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
          "ngrok-skip-browser-warning": "true",
        },
  ...
  getFileUrl: (fileName) => {
    ...
    // For files using ngrok URL
    const fileUrl = `${API_URL}/uploads/${fileName.split("/").pop()}`
    return fileUrl
  },
